...
function OfferForm() {
  ...
  const handleChange = (e: ChangeEvent<HTMLInputElement | HTMLTextAreaElement | HTMLSelectElement>) => {
    ...
    if (name === 'price') {
      setForm({ ...form, [name]: value ? parseFloat(value) : '' });  // El valor se convierte a float si no está vacío
    } else {
  ...
  return (
    <div className='text-white flex flex-col'>
      ...
      <form className="max-w-sm mx-auto min-w-sm" onSubmit={handleSubmit}>
        ...
        {/* Campo Precio */}
        <InputForm text="Precio" name="price" value={form.price || ''} handleChange={handleChange} error={errors.price} type="number" />
